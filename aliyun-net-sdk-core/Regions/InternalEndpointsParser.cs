...
namespace Aliyun.Acs.Core.Regions
{
    class InternalEndpointsParser : IEndpointsProvider
    {
        ...
        private const String BUNDLED_ENDPOINTS_RESOURCE_PATH = "aliyun-net-sdk-core.vscode.Regions.endpoints.xml";
        ...
        public List<Product> GetProducts()
        {
            ...
            string resourceName = BUNDLED_ENDPOINTS_RESOURCE_PATH;
            //string resourceName = BUNDLED_ENDPOINTS_RESOURCE_PATH;
